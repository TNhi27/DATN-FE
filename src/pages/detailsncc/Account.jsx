                        ...
                        <div style={{ marginTop: '20px' }} className="row">
                            <div className="col-lg-4 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input  value={obj.password} onChange={(e)=>setObj({...obj,password:e.target.value})} type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" />
                            ...
                            <div className="col-lg-4 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input value={obj.newP} onChange={(e)=>setObj({...obj,newP:e.target.value})} type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" />
                            ...
                            <div className="col-lg-4 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input value={obj.confirmP} onChange={(e)=>setObj({...obj,confirmP:e.target.value})} type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" />
